...
def add_paps_config(cfg):
    ...
    # PAPS semantic segmentation head.
    ...
    # PAPS instance segmentation head.
    cfg.MODEL.INS_EMBED_HEAD = CN()
    cfg.MODEL.INS_EMBED_HEAD.NAME = "PAPSInsEmbedHead"
    ...
    cfg.MODEL.PAPS.MODE = "amodal"
    cfg.MODEL.PAPS.STUFF_AREA = 2048
    cfg.MODEL.PAPS.CENTER_THRESHOLD = 0.1
    cfg.MODEL.PAPS.NMS_KERNEL = 7
    cfg.MODEL.PAPS.TOP_K_INSTANCE = 200
    # If set to False, Panoptic-DeepLab will not evaluate instance segmentation.
    cfg.MODEL.PAPS.PREDICT_INSTANCES = True
    cfg.MODEL.PAPS.USE_DEPTHWISE_SEPARABLE_CONV = False
    ...
    cfg.MODEL.PAPS.SIZE_DIVISIBILITY = -1
    # Only evaluates network speed (ignores post-processing).
    cfg.MODEL.PAPS.BENCHMARK_NETWORK_SPEED = False
